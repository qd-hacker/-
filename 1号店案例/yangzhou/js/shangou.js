...
$(function () {
    ...
    $("#lunbo-b li").mouseenter(function () {
        ...
        $("#luobo ul li").eq($(this).index()).stop().fadeIn(700).siblings().stop().fadeOut(700);
    });
    autoPlayq();
    function autoPlayq() {
        timer = setInterval(function () {
            ...
            $("#luobo ul li").eq(j).stop().fadeIn(700).siblings().stop().fadeOut(700);
        }, 2000);
    }
...
$(function () {
    $(".zimu-t a").not(":last").click(function () {
        ...
        var top = $(".zmxh").eq(_index).offset().top-50;
        $("#city").animate({
            scrollTop: top
        }, 800)
    });
